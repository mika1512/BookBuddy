...
export default function Nav({show}) {
  ...
  return (
    ...
    <aside className={(show?'left-0':'-left-full')+" top-0 text-slate-300 font-bold p-4 fixed w-full bg-purple-800 h-screen md:static md:w-auto transition-all"}>
    {/* <aside className={(show?'left-0':'-left-full')+" top-0 text-gray-500 p-4 fixed w-full bg-bgGray h-full md:static md:w-auto transition-all"}> */}
      {/* <aside className={`${show ? 'left-0' : '-left-full'} fixed top-0 left-0 h-full w-full md:w-auto bg-blue-900 text-white p-4 transition-all`}> */}
